    ...
    <View style={styles.container}>
      <View style={styles.topRow}>
        <View style={styles.iconContainer}>
          <Icon name="treasure-chest" size={32} color={colors.surface} />
        </View>
        <View style={styles.textContainer}>
          <Text style={styles.label}>Trésor des dons</Text>
      ...
      <TouchableOpacity
        ...
        <Text style={styles.donateText}>Faire un don au trésor</Text>
      </TouchableOpacity>
    </View>
  );
}
